                ...
                <div className='wrapper'>
                    ...
                    <ContextSection
                        context={`
                            ...
                            세부는 어느 클럽을가나 항상 상주?하는 
                            직업 피싱X들이 있는데요
                            눈이라도 마주치면 구애라도 하듯 눈웃음을 날리죠
                            특히 요즘은 중국인들까지  엄청 몰려와 피싱 단가까지 
                            엄청 올리고 있다하네요
                            또한 금,토,같은경우 여기가 한국'이태원 인가???
                            싶을정도로??
                    ...
                    <ContextSection
                        context={`
                            [r]단점
                            위험하다...
                            유명한 일화로 필리핀 남자친구가 호텔로 찾아와 
                            이슈가 된일이있었죠...
                            그리고 가장 많이 일어나는사고 도난사고!!
                            자고일어났는데 지갑이나 휴대폰이없다
                            즐기기도 빠듯한 시간에 이런일이생기면 
                            남은기간동안 절망?이겠죠?
                            그리고 국적불문을 상대하기에 성X도 심각합니다
                            클럽은 간단하게 맥주한잔 하시는곳으로 
                            생각하시면 될거같습니다
                    ...
                    <ContextSection
                        context={`
                            케이티비걸의 장점은 역시 실제 직접보고 
                            초이스를 할수있다는 점입니다.
                            또 마음에 들지않음 다른 업소로 이동하면 되구요.
                            단점으로는 아무래도 술+안주+아가씨LD 및 
                            2차비용+룸차지+각종팁등
                            세부 밤 문화중 가격이 가장 높다는데 있습니다.
                            거기다 원하시는 긴X이 아니라 최근 룰도바껴서 
                            대부분 짧은 X입니다.

                            [r]단점
                            1.주말같은경우 초저녁만되도 에이스들은 
                            다빠지고없습니다
                            2.술값이 상당히 비쌉니다
                            3.짧은X
                    ...
                    <ContextSection
                        context={`
                            ...
                            [r]장점:
                            KTV에 비해 비교적 건전하고, 인테리어가 깔끔합니다.
                            바바에들이 팁을 노리기보다는 매너와 서비스 
                            교육을 잘 받은 경우가 많습니다.
                            시간제(Time Charge)로 운영되는 경우가 많아 
                            바가지 요금이 적습니다.

                            [r]단점:
                            JTV는 술집 내에서만 대화하며 즐기는 곳으로, 
                            2차(바깥 데이트)가 금지되어 있습니다.
                            고급스러운 분위기인 만큼 맥주 한 잔당 가격이 높고, 
                            시간당 비용이 듭니다.
                            일본어가 주 언어이며, 영어나 한국어 
                            소통이 원활하지 않을 수 있습니다.
                        `}
                    ...
                    <ContextSection
                        context={`
                            ...
                            반면 에스코트걸은 짧은 시간이 아니라
                            정해진 날자로  진행됩니다
                            1박,3박 단위로 지내실수 있는겁니다
                            비용 또한  KTV 2차 비용과 비슷해
                            가성비 또한 더할 나위 없지요
                            단점이라면
                            사진으로만 선택하실수 있다는겁니다.
                            ​제일 좋은 방법은 사진으로 일단 초이스 하시되
                            원하시는 스타일을 구체적으로 말씀하시는겁니다.
                            물론 ​1박이상시 중간교체도 가능하시고요
                            여기서 잠깐!!동남아 필리핀에 오시면서
                            한국에서도 찾아보기 힘든 이쁜 연예인급을 
                            찾으시면 굉장히 곤란합니다.
                            동남아 여자들의 색다른 분위기와 그들과 즐기는
                            이색적인 만남을 기대하시면 되십니다
                            특히 안전하고 즐겁게 노시고 다시 일상으로 돌아가시면 
                            그것이 최고라는점 잊지마십시요!!
                        `}
                    />
