      ...
      <div className="container">
        ...
        <ul className={`${isMenuOpen ? "open" : ""}`}>
          ...
          <li><NavLink to={'/'} className={({ isActive }) => `${isActive ? 'active' : ''} header-pc`}>
            ...
            세부클럽</NavLink></li>
          <li><NavLink to={'/philippine-nightlife'} className={({ isActive }) => isActive ? 'active' : ''}>세부클럽•세부KTV•세부JTV</NavLink></li>
          <li><NavLink to={'/filipino-personality'} className={({ isActive }) => isActive ? 'active' : ''}>필리핀 팁문화</NavLink></li>
          <li><NavLink to={'/philippine-hangul'} className={({ isActive }) => isActive ? 'active' : ''}>필리핀 현지 대표 음식</NavLink></li>
